...
API_KEY_DJAMIL='WssZcOtIJgXLakj7Wod1t3aAqiKXvTZA' # Staging Dev Burner
API_KEY_RSABHK='DfMebVra5Ppoz82QM09YDhRDNRFJ4qX1' # Staging Dev Burner
FORCE_IPV6=false  # Set to true to force IPv6 resolution

# Base directory
BASE_DIR="/Users/miftahululum002/projects/serenic/experiments/test-analysis-new-deduplication"
